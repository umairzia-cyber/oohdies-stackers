...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockRevenueTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface MockRevenueToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockRevenueToken;
    waitForDeployment(): Promise<this>;

    interface: MockRevenueTokenInterface;
