...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IRewardVaultDepositInterface extends Interface {
    getFunction(nameOrSignature: "depositReward"): FunctionFragment;
  ...
  export interface IRewardVaultDeposit extends BaseContract {
    
    connect(runner?: ContractRunner | null): IRewardVaultDeposit;
    waitForDeployment(): Promise<this>;

    interface: IRewardVaultDepositInterface;
