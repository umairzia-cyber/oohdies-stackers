...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface FalseReturnERC20Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface FalseReturnERC20 extends BaseContract {
    
    connect(runner?: ContractRunner | null): FalseReturnERC20;
    waitForDeployment(): Promise<this>;

    interface: FalseReturnERC20Interface;
