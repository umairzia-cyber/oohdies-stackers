...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface BananaTokenInterface extends Interface {
    getFunction(nameOrSignature: "INITIAL_SUPPLY" | "allowance" | "approve" | "balanceOf" | "burn" | "burnFrom" | "decimals" | "name" | "owner" | "pause" | "paused" | "renounceOwnership" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership" | "unpause"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'unpause', data: BytesLike): Result;
  ...
  export interface BananaToken extends BaseContract {

    connect(runner?: ContractRunner | null): BananaToken;
    waitForDeployment(): Promise<this>;

    interface: BananaTokenInterface;
