...
export const EARNING_ENGINE_ABI = [
  ...
  "function activeWeightForAsset(address asset) view returns (uint256)",
  "function collectionQ() view returns (address)",
  "function collectionQMultiplierBps() view returns (uint256)",
  "function getWeight(uint256 tokenId) view returns (uint256)",
  "function syncCollectionQ(uint256 tokenId)",
] as const;
